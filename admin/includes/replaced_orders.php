    ...
    <div class="home">
        ...
        <div class="home-content">
            <div class="new-orders">
                <table>
                    <tr>
                        <h1 style="margin: 20px; color: gray">Replaced orders</h1> 
                    </tr>
                    <tr>
                        <th>Invoice</th>
                        <th>Product</th>
                            ...
                            if($cust_id != 0){
                                ...
                                <tr>
                                    <td>
                                        $invoice_no<br><br>
                                        $date<br><br>
                                        <p class='order-status os-rpc'>Replaced</p>  
                                    </td>
                                    <td>
                    ...
                    <ul>
                        ...
                        if(isset($_GET['page'])){
                            ...
                            for($i=1; $i<=$total_pages; $i++){
                                if($present_page == $i){
                                    echo "<a href='index.php?replaced_orders&page=$i'><li class='active'>$i</li></a>";
                                }else{
                                    echo "<a href='index.php?replaced_orders&page=$i'><li>$i</li></a>";
                                }
                            }
                            if($present_page < $total_pages){
                                $next_page = $present_page + 1;
                                echo "<a href='index.php?replaced_orders&page=$next_page'><li style='width: 70px; padding: 10px; border-radius: 20px'>Next</li></a>";
                            }else{
                                echo "<a href='index.php?replaced_orders&page=1'><li style='width: auto; padding: 10px; border-radius: 20px'>First page</li></a>";
                            }
                        }
